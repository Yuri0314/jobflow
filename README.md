...
To smoke test the built CLI, runtime persistence, result processing, and a real
headless Chromium/Edge fixture session together:

```powershell
corepack pnpm --filter @jobflow/cli smoke:automation-fixture-browser
```
